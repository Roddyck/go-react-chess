      ...
      queen: (
        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45">
          <g fill="#fff" stroke="#000" strokeLinejoin="round" strokeWidth="1.5">
            <path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-.3-14.1-5.2 13.6-3-14.5-3 14.5-5.2-13.6L14 25 6.5 13.5z"></path>
      ...
      rook: (
        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45">
          ...
          >
            <path
              strokeLinecap="butt"
              d="M9 39.3h27v-3H9zM12 36.3v-4h21v4zM11 14.3v-5h4v2h5v-2h5v2h5v-2h4v5"
            ></path>
            <path d="m34 14.3-3 3H14l-3-3"></path>
            <path
              strokeLinecap="butt"
              strokeLinejoin="miter"
              d="M31 17.3v12.5H14V17.3"
            ></path>
            <path d="m31 29.8 1.5 2.5h-20l1.5-2.5"></path>
            <path fill="none" strokeLinejoin="miter" d="M11 14.3h23"></path>
          </g>
        </svg>
      ),
      bishop: (
